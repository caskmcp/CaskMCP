...
CaskMCP supports OpenTelemetry trace exports as a capture input.
...
- OTEL instrumentation often omits request/response bodies. CaskMCP still compiles useful tools from method/path/status metadata.
